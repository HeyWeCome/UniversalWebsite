 ...
 -->
  ...
  <body>
    ...
    <div class="leftColumns" id="leftColumns">
    	<button class="allColumns" id="allColumns1" onclick="showColumnsOrNot1()">所有栏目</button>
    ...
    <div class="rightTable">
	   <!--  <div class="buttons">
		...
		<button onclick="refresh2()" type="button" class="btn btn-primary " style="color:#5E6F8A;background-color:#fff;">&nbsp;刷新&nbsp;</button>
	    <!--表格，样式在js中定义-->
